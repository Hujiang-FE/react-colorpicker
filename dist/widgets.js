		...
		renderHeadbar: function renderHeadbar() {
			return React.createElement(
				...
				React.createElement(
					'div',
					{ className: 'color' },
					React.createElement('span', { className: 'current-color', style: { backgroundColor: this._getCurrentColor() } }),
					React.createElement(
						'span',
				...
				React.createElement(
					'div',
					{ className: 'input' },
					React.createElement('input', { type: 'text', value: this._getCurrentColor() })
				),
				React.createElement(
					'div',
					{ className: 'more' },
